package com.usic.conteo.controller.publico_acyt;
...
public class VistaPublicaAcytController {
    ...
    public String vista_acyt(Model model) {
        ...
        return "publico_acyt/vista-acyt";
    }
    ...
    public String tablaMesasPorCarerra(@RequestParam("idCarrera") Long idCarrera, Model model) throws Exception {
        ...
        return "publico_acyt/vista-mesa-acyt";
    }
    ...
    public String mostrar_carrera(Model model, @PathVariable("params")Long idCarrera) throws Exception {
        ...
        return "publico_acyt/mesa-carrera-acyt";
    }
}
